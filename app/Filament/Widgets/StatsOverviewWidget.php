...
class StatsOverviewWidget extends BaseWidget
{
    ...
    protected function getStats(): array
    {
        ...
        // Build trend data (last 14 days) — single query grouped by date
        $trendRows = TestRun::whereIn('status', ['passing', 'failed'])
        ...
        $trend = collect(range(13, 0))
            ->map(fn ($daysAgo) => (int) ($trendRows[now()->subDays($daysAgo)->toDateString()] ?? 0))
            ->toArray();
